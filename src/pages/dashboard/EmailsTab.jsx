  ...
  return (
    <>
              ...
              >
                ...
                {error && !showGstModal && !showPanModal && !showSetup2FAModal && !showChangePasswordModal && <div className="error-message" style={{ color: 'red', marginBottom: '16px', backgroundColor: '#fee2e2', padding: '10px', borderRadius: '4px' }}>{error}</div>}
